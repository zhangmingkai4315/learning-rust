...
pub fn quick_select<T: PartialOrd + Debug + Clone>(dataset: &mut [T], start: usize, end: usize, k: usize) -> T
{
...
pub fn partition<T: PartialOrd + Debug + Clone>(dataset: &mut [T], start: usize, end: usize) -> usize{
    if start == end {
        return start;
    }
